...
//  DesignCode
//
//  Created by Pratyush Sharma on 29/07/20.
...
struct CourseView: View {
    ...
    var body: some View {
        ZStack(alignment: .top) {
            ...
            .frame(maxWidth: show ? .infinity : screen.width - 60.0)
            .frame(maxHeight: show ? 460 : 280)
            ...
            .gesture (
                ...
                DragGesture().onChanged { val in
                    guard val.translation.height < 300 else { return }
                    guard val.translation.height > 0 else { return }
                    self.activeView = val.translation
                }
                .onEnded {_ in
...
//                    .animation(nil)
        ...
        .rotation3DEffect(Angle(degrees: Double(self.activeView.height) / -10), axis: (x: 0, y: 1, z: 0))
